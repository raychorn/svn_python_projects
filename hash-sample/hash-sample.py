class Dict2(dict):
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(Dict2, self).__init__(*args)
    
    def __getitem__(self, key):
        return super(Dict2, self).__getitem__(key) if (super(Dict2, self).has_key(key)) else self.default

    def __setitem__(self, key, value):
        if (super(Dict2, self).has_key(key)):
            super(Dict2, self).__delitem__(key)
...
if (__name__ == '__main__'):
    ...
    print 'Test dict recast to Dict2(), if this work you will not see any exceptions.'
