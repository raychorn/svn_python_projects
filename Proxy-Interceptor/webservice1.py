...
LOG_FILENAME = os.sep.join([fpath,'webservice1.log'])
...
logger = logging.getLogger('webservice1')
...
if __name__ == '__main__':
    '''
    python webservice1.py 127.0.0.1:9100
    '''
    import re
    ...
    def __init__():
        logger.info('webservice1 %s started !!!' % (__version__))
        flush_handlers()
        app.run()
