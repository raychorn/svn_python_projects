...
_console=['Z:\\python projects\\svnHotBackups\\sftp.py']
_packages = ['Z:\\python projects\\@lib\\lib']
_includes = []
_excludes = ['Crypto.PublicKey._fastmath', 'Crypto.Util.winrandom', 'psyco_linux', 'r_hmac']
