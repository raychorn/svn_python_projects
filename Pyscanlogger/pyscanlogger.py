## {{{ http://code.activestate.com/recipes/576690/ (r5)
#!/usr/bin/env python
"""
...
def main():
    ...
    o.add_option("-f", "--logfile", dest="logfile", help="File to save logs to",
                 default="/var/log/scanlog" if (_utils.isUsingLinux or _utils.isUsingMacOSX) else os.path.abspath('./scanlog'))
...
if __name__ == '__main__':
    main()
## end of http://code.activestate.com/recipes/576690/ }}}