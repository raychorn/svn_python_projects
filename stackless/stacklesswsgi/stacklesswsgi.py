...
print 'END!'
print '='*30
if (len([f for f in sys.path if (f.find('\@lib') > -1)]) == 0):
    sys.path.insert(0,'f:\@Vyper Logix Corp\@Projects\python\@lib')
print 'BEGIN:'
for f in sys.path:
    print f
print 'END!'
...
if (__name__ == '__main__'):
    ...
    _psyco.importPsycoIfPossible(func=application)
    
    print 'Starting...'
    s = Server(('127.0.0.1', 8888), application)
    s.start()
