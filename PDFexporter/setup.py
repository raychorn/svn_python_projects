...
sys.path.append(r"Z:\\python projects\\@lib")
...
##################################################  ##############
packages = ["lib"] # "scipy.signal", "numpy.core", "UniversalLibrary",
includes = ['lib.ui.PyDialog', 'wx.lib.mixins.treemixin'] # "wx.lib.wordwrap"
...
setup(
    ...
    zipfile = None,
    windows = [test_wx],
    data_files=["indian_python(200x153).png","icon.ico","animated_indicator.gif"],
