...
from vyperlogix.wx import wxGetNumberFromUser
...
class wxHanoiFrame( wxFrame ):
    ...
    def OnInpNumDiscs( self, _event ):
        self.numDiscs = wxGetNumberFromUser.wxGetNumberFromUser( 'Discs:', 'Number of Discs', 
    ...
    def OnInpSleepTime( self, _event ):
        self.sleepTime = wxGetNumberFromUser.wxGetNumberFromUser( 'Wait [sec/10]:', 'Time between Moves', 
    ...
    def MoveDisc( self, src, dst ):
        ...
        width, height = self.GetClientSize()
        self.Draw( wxClientDC( self ), width, height )
        wxMilliSleep(100 * self.sleepTime )
