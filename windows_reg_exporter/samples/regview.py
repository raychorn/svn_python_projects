...
from vyperlogix.win._registry import Registry
...
if __name__ == '__main__':
    ...
    __folder__ = r'C:\Windows\System32\config'
    filenames = ['COMPONENTS','DEFAULT','SAM','SECURITY','SOFTWARE','SYSTEM']
    filenames = [os.sep.join([__folder__,f]) for f in filenames]
