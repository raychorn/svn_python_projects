...
if %1. == 1. python25 -O setup.py py2exe --packages=Crypto,paramiko
REM if %1. == 2. python25 -O setup_sftp.py py2exe --packages=Crypto,paramiko
...
REM echo "2" means setup_sftp.py
echo END! -----------------------------------------------------------------------------------------------------
