...
class MainFrame(wx.App):
    def OnInit(self):
	import pyEggsUpdater_Dialog
	self.__child_frame = pyEggsUpdater_Dialog.Dialog(None, title=__productName__)
	...
	dlg = wx.MessageDialog(self.__child_frame, __ChangeLog__, 'Change Log', wx.CANCEL | wx.ICON_INFORMATION)
	dlg.ShowModal()
	dlg.Destroy()
