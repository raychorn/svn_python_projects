...
#GenPasswd.GenPasswdFriendlyAlphas(maxlength=16,uniquely=True)
__seed__ = 'MSwArgHqPTGdjNYD'

def dummyDB():
    return [{"user":"raychorn","password":"peekab00", "otp_seed":__seed__},{"user":"ram","password":"yeahokay", "otp_seed":""}]

print """To test please access the following url and \n
	scan the QR code into your Google Authenicator App.\n 
	Now your 2f setup for as user raychorn is complete. \n
	Use this for OTP while loginng in as raychorn.\n
	This URL is only for the eyes of user raychorn.\n
	This uses otp_seed which is generated when use was created and is unique to user.\n
	URL = """+ pyg2fa.qrCodeURL("http://g2fa-example.com", __seed__)+"\n\n\n"
