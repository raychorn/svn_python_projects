...
#
# Your path.
PATH=/usr/kerberos/sbin:/opt/ActivePython-2.5/bin:/usr/kerberos/bin:/usr/local/bin:/bin:/usr/bin:/usr/X11R6/bin:/local/home/admin/bin
# Location of the webserver.py file
DAEMON=/local/var/www/apps/molten4/magma_molten_4/djangocerise/webserver.pyc
# PID file to be created. It must match with the PID file in the
# configuration module.
PIDFILE=/var/run/django-molten4.pid
...
# in the python path.
BASEDIR=/local/var/www/apps/molten4/magma_molten_4/djangocerise
# Config module for the webserver.
CONFIG=myprojectconf
#
####################################

DESC="Molten4 Django Server"
CWD="`pwd`"
