...
print 'The computer name is "%s".' % (_cname)
if (_cname == 'web22.webfaction.com'):
    DATABASE_ENGINE = 'mysql'         # 'postgresql_psycopg2', 'postgresql', 'mysql', 'sqlite3' or 'ado_mssql'.
    DATABASE_NAME = 'raychorn_mycred' # Or path to database file if using sqlite3.
    DATABASE_USER = 'raychorn_mycred' # Not used with sqlite3.
...
ROOT_URLCONF = 'mycreditmatters_vyperlogix_com.urls'
...
INSTALLED_APPS = (
    ...
    'mycreditmatters_vyperlogix_com.home',
    'mycreditmatters_vyperlogix_com.polls',
)

handler404 = 'mycreditmatters_vyperlogix_com.views.default'
