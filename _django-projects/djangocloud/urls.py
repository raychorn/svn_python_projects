...
from views.default import rest_handle_get_applications, rest_handle_add_application, rest_handle_remove_application
...
if (has_users):
    ...
    __api_dict__1['remove_application'] = SmartFuzzyObject({'url':'/remove/application/','func':rest_handle_remove_application,'isPostRequired':True})
    pass
