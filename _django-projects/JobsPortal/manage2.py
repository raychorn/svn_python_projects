...
try:
    ...
    if (not isUsingWindows):
        __app__ = 'JobsPortal/JobsPortal'
    else:
        __app__ = '_django-projects/JobsPortal'
...
if (__name__ == "__main__"):
	...
	if (0):
	    ...
	    data = serializers.serialize("json", models.Cities.objects.all())
	    fpath = os.path.abspath('./data/cities.json')
