...
def default(request):
    ...
    return views.default(request,apiMap=__apiMap__,domain=__domainName,secure_endpoint=__api_dict__2['secure_endpoint'],insecure_endpoint=__api_dict__2['insecure_endpoint'],air_id=air_id,air_version=air_version)
