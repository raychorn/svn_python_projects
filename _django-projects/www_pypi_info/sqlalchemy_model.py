...
class Jos_Menu_Types(SQLAgent.BaseObject):
    pass

class Jos_Categories(SQLAgent.BaseObject):
    pass

class Jos_Content(SQLAgent.BaseObject):
    pass

class Jos_Content_Frontpage(SQLAgent.BaseObject):
    pass

class Jos_Sections(SQLAgent.BaseObject):
    pass

class Jos_Users(SQLAgent.BaseObject):
    pass

class Jos_MXC_Favoured(SQLAgent.BaseObject):
    pass

class Jos_Docman(SQLAgent.BaseObject):
    pass

class Jos_Docman_Licenses(SQLAgent.BaseObject):
    pass
