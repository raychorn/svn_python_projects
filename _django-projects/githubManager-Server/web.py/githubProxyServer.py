...
class GithubProxyServer:
	...
	def take_if_possible(items,index):
	    ...
	    __is__GET_COMMAND__ = __cmd__ == GithubProxyServer.__GET_COMMAND__
	    __is__USER_COMMAND__ = __cmd__ == GithubProxyServer.__USER_COMMAND__
...
if __name__ == '__main__':
    '''
    python githubProxyServer.py 127.0.0.1:9999

    python githubProxyServer.py --proxy=127.0.0.1:8888 127.0.0.1:9999
    '''
    import re
