...
echo $PYTHONPATH
python2.5 webserver.pyc --conf myprojectconf --host 127.0.0.1:9000 --daemon=1 --kill=1
python2.5 webserver.pyc --conf myprojectconf --host 127.0.0.1:9001 --daemon=1 --kill=1
python2.5 webserver.pyc --conf myprojectconf --host 127.0.0.1:9002 --daemon=1 --kill=1
