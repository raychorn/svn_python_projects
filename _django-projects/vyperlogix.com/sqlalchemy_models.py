...
conn_str = 'mysql://%s:%s@%s:%s/freehosts' % (settings.DATABASE_USER,settings.DATABASE_PASSWORD,settings.DATABASE_HOST,settings.DATABASE_PORT)
conn_str2 = 'mysql://%s:%s@%s:%s/iso_data' % (settings.DATABASE_USER,settings.DATABASE_PASSWORD,settings.DATABASE_HOST,settings.DATABASE_PORT)
