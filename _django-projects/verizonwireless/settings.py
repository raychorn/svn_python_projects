...
if (django_utils._cname in ['wca10408lditamu.uswin.ad.vzwcorp.com']):
    DATABASE_NAME = 'django-app1'                        # Or path to database file if using sqlite3.
    ...
    print 'WARNING: %s from %s' % (django_utils._cname,__file__)
