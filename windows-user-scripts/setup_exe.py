...
_console=[os.sep.join([os.getcwd(),'windows-lock-if-not-correct-user.py'])]
_packages = [[f for f in sys.path if (f.endswith('@lib'))][0]]
_includes = ['win32api','win32file','win32con','win32net']
...
_fpath2 = os.sep.join([_root_,'windows-user-scripts'])
