...
class ApexBase64Binary:
    ...
    Access to the original object is through the insatnce member binaryObject
    """
    ...
    @classmethod
    def fromEncodedString(cls, encoded_str):
        """ Create an ApexBase64Binary instance from a base64 encoded string
        
        @param encodedString: base64 encoded binary object
