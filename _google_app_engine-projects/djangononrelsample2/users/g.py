...
air_sender = lambda key:__air_sender__.get(key,'jobs.portal@vyperlogix.com') if (__air_sender__) else None

__air_site__ = {}
__air_site__[symbol_svncloud] = None
air_site = lambda key:__air_site__.get(key,'Jobs Portal @ Vyper Logix Corp.') if (__air_site__) else None

updater_domainName = 'djangononrelsample2.vyperlogix.com'
