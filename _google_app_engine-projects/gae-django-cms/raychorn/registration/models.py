...
__account_password_email__ = '''
Welcome to VyperBlog !

In order to change your account password please visit the following link:

https://{{ site }}/account/password/{{ email_address }}/
...
class RegistrationManager(models.Manager):
    ...
    def create_inactive_user(self, username, password, email, first_name, last_name, domain_override="", send_email=True):
        """
        ...
        if send_email:
            ...
            subject = django_utils.render_from_string(__registration_activation_email_subject__,context=Context({ 'site': current_site },autoescape=False))
            ...
            message = django_utils.render_from_string(__registration_activation_email__,context=context)
