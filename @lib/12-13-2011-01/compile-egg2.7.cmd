...
if exist compile-egg_%2_2.7.log del compile-egg_%2_2.7.log

c:\python27\python2.7.exe -OO compile-all.py "%1" > compile-egg_%2_2.7.log 2>&1

if .%3 == .END goto CLOSEIT
